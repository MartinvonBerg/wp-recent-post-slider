...
function wp_recent_post_scripts()
{
  ...
  if (is_front_page() || is_home()) {
    ...
    wp_enqueue_style('wp_recent_post_style1', $plugin_url . 'css/slick.min.css');
    wp_enqueue_style('wp_recent_post_style2', $plugin_url . 'css/slick-theme.min.css');
    wp_enqueue_style('wp_recent_post_style3', $plugin_url . 'css/wp-recent-post-slider.min.css');
    ...
    wp_enqueue_script('wp_recent_post_script2', $plugin_url . 'js/wp-recent-post-slider.min.js', array('jquery'), '1.10.2', true);
  }
}